    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-sky-800 to-teal-950">
            ...
            <section className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pb-16">
                ...
                >
                    <FeatureList items={[
                        t("phase1Feature1"), t("phase1Feature2"), t("phase1Feature3"),
                ...
                >
                    <FeatureList items={[
                        t("phase2Feature1"), t("phase2Feature2"), t("phase2Feature3"),
                        t("phase2Feature4"), t("phase2Feature5"), t("phase2Feature6"),
                        t("phase2Feature7"), t("phase2Feature8"),
                    ]} />
                </Phase>
                ...
                >
                    <FeatureList items={[
                        ...
                        t("phase3Feature4"), t("phase3Feature5"), t("phase3Feature6"),
                    ]} />
                </Phase>
                ...
                <Phase
                    ...
                    accentColor="bg-purple-500"
                >
                    <SubSection title={t("phase4InitialFocus")} items={[
                        t("phase4Sport1"), t("phase4Sport2"),
                    ]} />
                    <SubSection title={t("phase4Expansion")} items={[
                        t("phase4Sport3"), t("phase4Sport4"), t("phase4Sport5"),
                        t("phase4Sport6"), t("phase4Sport7"),
                    ]} />
            ...
            <footer className="relative z-10 py-5 flex items-center justify-center">
                <p className="text-xs text-white/40">&copy; {new Date().getFullYear()} {t("footerCopyright")}</p>
            </footer>
        </div>
    );
}
